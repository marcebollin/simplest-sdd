...
The update instruction asks whether to leave old execution records untouched (the default) or delete them. Deletion requires your explicit choice and preserves specifications, plans, and decisions. New work no longer creates execution records or asks for a rating.
